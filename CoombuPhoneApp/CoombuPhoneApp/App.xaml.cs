...
namespace CoombuPhoneApp
{
    ...
    {        
        ...
        public static CoombuApi ClientApi { get; private set; }
        ...
        {
            bool rememberMe = Settings.Get("RememberMe") == null ? false : (bool)Settings.Get("RememberMe");
            if (rememberMe)
            {
                string token = Settings.Get("Token") == null ? "" : (string) Settings.Get("Token");
                ...
                {
                    ClientApi.IsAuthenticated = false;
                }
            }
        }
